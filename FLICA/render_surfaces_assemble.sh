...
do
	...
	convert ${i}_rh_bot.tif +repage -crop 465x180+105+282 -rotate -90 $RESIZE tmp1.png &
	convert ${i}_lh_bot.tif +repage -crop 465x180+30+282 -rotate 90 $RESIZE tmp2.png &
	convert ${i}_rh_top.tif +repage -crop 471x183+102+135 -rotate 90 $RESIZE tmp3.png &
	convert ${i}_lh_top.tif +repage -crop 471x183+27+135 -rotate -90 $RESIZE tmp4.png &
	convert ${i}_lh_lat.tif +repage $CROPSIDEVIEW2 tmp5.png &
	convert ${i}_rh_lat.tif +repage $CROPSIDEVIEW1 tmp6.png &
	convert ${i}_lh_med.tif +repage $CROPSIDEVIEW1 tmp7.png &
	convert ${i}_rh_med.tif +repage $CROPSIDEVIEW2 tmp8.png &
	. $SRCDIR/waitfor_quiet 0 # Join parallel tasks
	...
	convert +append ${i}_both_top.png ${i}_both_bot.png ${i}_both_lat.png ${i}_both_med.png "$OUTDIR"/${i}_all.png  &
done
. $SRCDIR/waitfor_quiet 0 # Join parallel tasks
cd ..
