...
% Last Modified by GUIDE v2.5 18-May-2011 11:04:56
...
handles.diff=jn_combineSubspecs(handles.in,'diff');
...
in_phas=jn_addphaseSubspec(handles.in,handles.phasValue);
in_phas_freq=jn_freqshiftSubspec(in_phas,handles.freqValue);
handles.current_subSpecs=in_phas_freq.specs;
handles.diff=jn_combineSubspecs(in_phas_freq,'diff');
handles.current_diffSpecs=handles.diff.specs;
