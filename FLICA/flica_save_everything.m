...
for k=1:K
    M.HKn(:,:,k)=M.HK(:,:,k)';
    M.HKscalen(:,:,k)=M.HKscale(:,:,k)';
    M.tmpMKn(:,:,k)=M.tmpMK(:,:,k)';
end

% save_vest(M.HKn(:,:,1), [outdir 'subjectCoursesOutEachModality1.txt'])
% save_vest(M.HKn(:,:,2), [outdir 'subjectCoursesOutEachModality2.txt'])
% save_vest(M.HKn(:,:,3), [outdir 'subjectCoursesOutEachModality3.txt'])
% save_vest(M.HKn(:,:,4), [outdir 'subjectCoursesOutEachModality4.txt'])
% save_vest(M.HKn(:,:,5), [outdir 'subjectCoursesOutEachModality5.txt'])
% save_vest(M.HKn(:,:,6), [outdir 'subjectCoursesOutEachModality6.txt'])
save_vest(M.HKscalen(:,:,1), [outdir 'subjectCoursesOutEachModalityScale1.txt'])
save_vest(M.HKscalen(:,:,2), [outdir 'subjectCoursesOutEachModalityScale2.txt'])
save_vest(M.HKscalen(:,:,3), [outdir 'subjectCoursesOutEachModalityScale3.txt'])
save_vest(M.HKscalen(:,:,4), [outdir 'subjectCoursesOutEachModalityScale4.txt'])
save_vest(M.HKscalen(:,:,5), [outdir 'subjectCoursesOutEachModalityScale5.txt'])
% save_vest(M.HKscalen(:,:,6), [outdir 'subjectCoursesOutEachModalityScale6.txt'])
% save_vest(M.HKscalen(:,:,7), [outdir 'subjectCoursesOutEachModalityScale7.txt'])
% save_vest(M.tmpMKn(:,:,1), [outdir 'subjectCoursesOutMV1.txt'])
% save_vest(M.tmpMKn(:,:,2), [outdir 'subjectCoursesOutMV2.txt'])
% save_vest(M.tmpMKn(:,:,3), [outdir 'subjectCoursesOutMV3.txt'])
% % save_vest(M.tmpMKn(:,:,4), [outdir 'subjectCoursesOutMV4.txt'])
% % save_vest(M.tmpMKn(:,:,5), [outdir 'subjectCoursesOutMV5.txt'])
% % save_vest(M.tmpMKn(:,:,6), [outdir 'subjectCoursesOutMV6.txt'])
save_vest(M.H_PCs, [outdir 'subjectCoursesPrecisionContributions.txt'])
